#ifndef ALGO_LAYER2_V2_H
#define ALGO_LAYER2_V2_H
...
void algo_layer2_v2(hls::stream<axi_t> &ch1_link_in,hls::stream<axi_t> &ne_link_in, hls::stream<axi_t> &em_link_in, hls::stream<axi_t> &mu_link_in,hls::stream<PFChargedObj> &link_out);
